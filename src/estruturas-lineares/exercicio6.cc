...
public:
    ...
    void empilha(int v){
        ...
        // ao empilhar, checa se o valor é menor ou igual ao do topo da pilha de mínimos
        // em caso afirmativo, empilha o valor na pilha de mínimos
        // checar é O(1), empilhar é O(1) -> a operação é O(1)
