...
class PilhaDe2Filas {
 public:
  ...
  // caso last_pushed seja verdadeiro, a pilha invertida seria construída do
  // zero caso contrário, a pilha invertida já estaria disponível, pois nenhum
  ...
  T pop() {
    ...
    ret = invertida.top();
    // cria uma fila auxiliar, de modo a manter a invertida disponível para
    // consulta de top
